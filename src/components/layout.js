    ...
    <>
      ...
      <main>
        ...
        <p>
          ...
          that you want to keep, and (Edit) to choose a font manually. The text
          ...
          largely a matter of intuition, but we approach this problem with a
          neural net. See Github for more technical details.
        </p>
      </main>
      <footer>
        FOOTER
